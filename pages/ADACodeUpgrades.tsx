...
const ADACodeUpgrades: React.FC = () => {
  ...
  return (
    <>
      <SEO
        title="Austin ADA & Code Upgrades | Neighbors Mobile Detailers"
        description="Professional ADA and code compliance upgrades in Austin, Arizona. Accessibility improvements, ramps, handrails, restroom clearances, signage. Pass inspection the first time. Free estimates."
        keywords="Austin ADA upgrades, Austin code compliance, ADA contractor Austin, accessibility upgrades Austin, building code compliance Austin, ADA ramps Austin"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mt-4 mb-6">
                Austin ADA & Code Upgrades | Pass Inspection the First Time
              </h1>
            ...
            <div className="relative">
              <div className="overflow-hidden h-[500px] md:h-[600px] rounded-2xl">
                <img 
                  ...
                  alt="ADA and Code Upgrade Services in Austin, Arizona" 
