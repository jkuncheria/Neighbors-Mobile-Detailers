...
const TenantImprovements: React.FC = () => {
  ...
  return (
    <>
      <SEO
        title="Austin Tenant Improvements | Neighbors Mobile Detailers"
        description="Professional tenant improvements in Austin, Arizona. Fast, code-compliant build-outs for offices and retail with minimal downtime. Demolition, drywall, lighting, ADA upgrades. Free estimates."
        keywords="Austin tenant improvements, Austin office build-out, tenant improvement contractor Austin, commercial build-out Austin, office renovation Austin"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mt-4 mb-6">
                Austin Tenant Improvements | Fast, Code-Compliant Build-Outs with Minimal Downtime
              </h1>
            ...
            <div className="relative">
              <div className="overflow-hidden h-[500px] md:h-[600px] rounded-2xl">
                <img 
                  ...
                  alt="Tenant Improvements and Commercial Build-Outs in Austin, Arizona" 
