...
const ParadiseValleyAutoDetailing: React.FC = () => {
  ...
  const localFeatures = [
    {
      icon: <Gem className="w-8 h-8 text-[#FF9E2C]" />,
      ...
      <section className="relative py-24 bg-gray-950 px-4 md:px-16">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <span className="text-[#FF9E2C] font-bold tracking-wider text-sm uppercase">PARADISE VALLEY SERVICE AREA</span>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mt-4 mb-6">
                Luxury Auto Detailing in Paradise Valley
              </h1>
              <p className="text-lg text-gray-400 mb-4 leading-relaxed">
                Paradise Valley is home to Arizona's most prestigious automobiles and discerning collectors. Neighbors Mobile Detailers provides elite detailing services worthy of your luxury investment - delivered with the discretion and professionalism you expect.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Why Paradise Valley Trusts Neighbors Mobile Detailers
              </h2>
