  ...
  return (
    <>
      ...
      <section className="relative py-12 bg-gradient-to-br from-gray-950 via-stone-900 to-gray-950 px-4 md:px-16 overflow-hidden">
        <div className="absolute top-0 left-0 w-64 h-64 bg-[#FF9E2C]/5 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-[#FF9E2C]/5 rounded-full blur-3xl"></div>
        
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-2 bg-[#FF9E2C]/10 border border-[#FF9E2C]/30 rounded-full px-6 py-2 mb-6">
            <Users className="w-5 h-5 text-[#FF9E2C]" />
            <span className="text-[#FF9E2C] font-semibold text-sm uppercase tracking-wider">Members Pricing</span>
          </div>

          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            Our Complete <span className="text-[#FF9E2C]">Pricing Menu</span>
          </h1>
          
          <div className="bg-[#FF9E2C]/10 border border-[#FF9E2C]/30 rounded-xl p-4 mb-8 max-w-2xl mx-auto">
            <p className="text-[#FF9E2C] font-bold text-lg mb-1">🎉 Your 20% Discount Applies to ALL Prices Below!</p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/contact"
              className="bg-[#FF9E2C] hover:bg-yellow-400 text-black font-bold py-3 px-8 rounded-xl shadow-lg transition transform hover:scale-105 text-center"
            >
              Book Now
            </Link>
            <a
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
            <div className="bg-stone-800 rounded-xl p-6 border border-stone-700">
              <h3 className="text-[#FF9E2C] font-bold mb-2">Basic Interior Cleanup <span className="text-gray-400 font-normal text-sm">*1-2 Hours</span></h3>
            ...
            <div className="bg-stone-800 rounded-xl p-6 border border-stone-700">
              <h3 className="text-[#FF9E2C] font-bold mb-2">Complete Interior Refresh <span className="text-gray-400 font-normal text-sm">*3-6 Hours</span></h3>
            ...
            <div className="bg-stone-800 rounded-xl p-6 border border-stone-700">
              <h3 className="text-[#FF9E2C] font-bold mb-2">Basic Exterior Wash <span className="text-gray-400 font-normal text-sm">*20-40 Min</span></h3>
            ...
            <div className="bg-stone-800 rounded-xl p-6 border border-stone-700">
              <h3 className="text-[#FF9E2C] font-bold mb-2">Complete Exterior Detail <span className="text-gray-400 font-normal text-sm">*1-3 Hours</span></h3>
          ...
          <div className="space-y-8">
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    <tr className="border-b border-stone-700">
                      ...
                      <td className="py-4 px-4 text-center text-[#FF9E2C] font-bold">$69</td>
                      <td className="py-4 px-4 text-center text-[#FF9E2C] font-bold">$79</td>
                      <td className="py-4 px-4 text-center text-[#FF9E2C] font-bold">$99</td>
                      <td className="py-4 px-4 text-center text-[#FF9E2C] font-bold">$109</td>
                    </tr>
                    <tr className="border-b border-stone-700">
                      <td className="py-4 px-6 text-white font-medium">Interior</td>
                      <td className="py-4 px-4 text-center text-[#FF9E2C] font-bold">$69</td>
                      <td className="py-4 px-4 text-center text-[#FF9E2C] font-bold">$79</td>
                      <td className="py-4 px-4 text-center text-[#FF9E2C] font-bold">$89</td>
                      <td className="py-4 px-4 text-center text-[#FF9E2C] font-bold">$109</td>
                    </tr>
                    <tr>
                      <td className="py-4 px-6 text-white font-medium">Full Car</td>
                      <td className="py-4 px-4 text-center text-[#FF9E2C] font-bold">$129</td>
                      <td className="py-4 px-4 text-center text-[#FF9E2C] font-bold">$149</td>
                      <td className="py-4 px-4 text-center text-[#FF9E2C] font-bold">$179</td>
                      <td className="py-4 px-4 text-center text-[#FF9E2C] font-bold">$209</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            {/* Complete Services */}
            <div className="bg-stone-800 rounded-2xl overflow-hidden border border-stone-700">
              <div className="bg-[#FF9E2C] px-6 py-4">
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    <tr className="border-b border-stone-700">
                      <td className="py-4 px-6 text-white font-medium">Exterior</td>
                      <td className="py-4 px-4 text-center text-[#FF9E2C] font-bold">$129</td>
                      <td className="py-4 px-4 text-center text-[#FF9E2C] font-bold">$139</td>
                      <td className="py-4 px-4 text-center text-[#FF9E2C] font-bold">$159</td>
                      <td className="py-4 px-4 text-center text-[#FF9E2C] font-bold">$179</td>
                    </tr>
                    <tr className="border-b border-stone-700">
                      <td className="py-4 px-6 text-white font-medium">Interior</td>
                      <td className="py-4 px-4 text-center text-[#FF9E2C] font-bold">$149</td>
                      <td className="py-4 px-4 text-center text-[#FF9E2C] font-bold">$169</td>
                      <td className="py-4 px-4 text-center text-[#FF9E2C] font-bold">$179</td>
                      <td className="py-4 px-4 text-center text-[#FF9E2C] font-bold">$209</td>
                    </tr>
                    <tr>
                      <td className="py-4 px-6 text-white font-medium">Full Car</td>
                      <td className="py-4 px-4 text-center text-[#FF9E2C] font-bold">$249</td>
                      <td className="py-4 px-4 text-center text-[#FF9E2C] font-bold">$279</td>
                      <td className="py-4 px-4 text-center text-[#FF9E2C] font-bold">$299</td>
                      <td className="py-4 px-4 text-center text-[#FF9E2C] font-bold">$359</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div className="bg-stone-800 rounded-2xl overflow-hidden border border-stone-700">
              ...
              <div className="grid grid-cols-2 md:grid-cols-6 gap-4 p-6">
                <div className="text-center">
                  ...
                  <p className="text-[#FF9E2C] font-bold text-xl">$109</p>
                </div>
                <div className="text-center">
                  <p className="text-gray-400 text-sm mb-1">Motorcycle Detail</p>
                  <p className="text-[#FF9E2C] font-bold text-xl">$149</p>
                </div>
                <div className="text-center">
                  <p className="text-gray-400 text-sm mb-1">Motorcycle Chrome Polish</p>
                  <p className="text-[#FF9E2C] font-bold text-xl">$49</p>
                </div>
                <div className="text-center">
                  <p className="text-gray-400 text-sm mb-1">RV Wash n' Wax</p>
                  <p className="text-[#FF9E2C] font-bold text-xl">$199</p>
                </div>
                <div className="text-center">
                  <p className="text-gray-400 text-sm mb-1">UTV Detail</p>
                  <p className="text-[#FF9E2C] font-bold text-xl">$119</p>
                </div>
                <div className="text-center">
      ...
      <section className="py-16 bg-gray-950 px-4 md:px-16">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="w-20 h-1 bg-[#FF9E2C] mx-auto mb-10"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="bg-stone-900 rounded-xl p-5 border border-stone-800">
              <div className="flex justify-between items-start mb-2">
                ...
                <span className="text-[#FF9E2C] font-bold">$9</span>
              </div>
            ...
            <div className="bg-stone-900 rounded-xl p-5 border border-stone-800">
              <div className="flex justify-between items-start mb-2">
                ...
                <span className="text-[#FF9E2C] font-bold">$20</span>
              </div>
            ...
            <div className="bg-stone-900 rounded-xl p-5 border border-stone-800">
              <div className="flex justify-between items-start mb-2">
                ...
                <span className="text-[#FF9E2C] font-bold">$40</span>
              </div>
            ...
            <div className="bg-stone-900 rounded-xl p-5 border border-stone-800">
              <div className="flex justify-between items-start mb-2">
                ...
                <span className="text-[#FF9E2C] font-bold whitespace-nowrap text-sm">$80 | $100 | $120</span>
              </div>
            ...
            <div className="bg-stone-900 rounded-xl p-5 border border-stone-800">
              <div className="flex justify-between items-start mb-2">
                ...
                <span className="text-[#FF9E2C] font-bold whitespace-nowrap text-sm">$79 | $99 | $119</span>
              </div>
            ...
            <div className="bg-stone-900 rounded-xl p-5 border border-stone-800">
              <div className="flex justify-between items-start mb-2">
                ...
                <span className="text-[#FF9E2C] font-bold whitespace-nowrap text-sm">$29 | $39 | $49</span>
              </div>
            ...
            <div className="bg-stone-900 rounded-xl p-5 border border-stone-800">
              <div className="flex justify-between items-start mb-2">
                ...
                <span className="text-[#FF9E2C] font-bold whitespace-nowrap text-sm">$139 | $159 | $199</span>
              </div>
            ...
            <div className="bg-stone-900 rounded-xl p-5 border border-stone-800">
              <div className="flex justify-between items-start mb-2">
                ...
                <span className="text-[#FF9E2C] font-bold whitespace-nowrap text-sm">$219 | $249 | $299</span>
              </div>
            ...
            <div className="bg-stone-900 rounded-xl p-5 border border-stone-800">
              <div className="flex justify-between items-start mb-2">
                ...
                <span className="text-[#FF9E2C] font-bold whitespace-nowrap text-sm">$399 | $459 | $559</span>
              </div>
            ...
            <div className="bg-stone-900 rounded-xl p-5 border border-stone-800">
              <div className="flex justify-between items-start mb-2">
                ...
                <span className="text-[#FF9E2C] font-bold whitespace-nowrap text-sm">$599 | $659 | $799</span>
              </div>
            ...
            <div className="bg-stone-900 rounded-xl p-5 border border-stone-800">
              <div className="flex justify-between items-start mb-2">
                ...
                <span className="text-[#FF9E2C] font-bold">$139</span>
              </div>
            ...
            <div className="bg-stone-900 rounded-xl p-5 border border-stone-800">
              <div className="flex justify-between items-start mb-2">
                ...
                <span className="text-[#FF9E2C] font-bold">$59</span>
              </div>
            ...
            <div className="bg-stone-900 rounded-xl p-5 border border-stone-800">
              <div className="flex justify-between items-start mb-2">
                ...
                <span className="text-[#FF9E2C] font-bold">$99</span>
              </div>
            ...
            <div className="bg-stone-900 rounded-xl p-5 border border-stone-800">
              <div className="flex justify-between items-start mb-2">
                ...
                <span className="text-[#FF9E2C] font-bold">$2-$5/Each</span>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="bg-stone-800 rounded-xl p-5 border border-stone-700">
              <div className="flex justify-between items-start mb-2">
                ...
                <span className="text-[#FF9E2C] font-bold whitespace-nowrap text-sm">$40 | $50 | $60</span>
              </div>
            ...
            <div className="bg-stone-800 rounded-xl p-5 border border-stone-700">
              <div className="flex justify-between items-start mb-2">
                ...
                <span className="text-[#FF9E2C] font-bold whitespace-nowrap text-sm">$69 | $79 | $89</span>
              </div>
            ...
            <div className="bg-stone-800 rounded-xl p-5 border border-stone-700">
              <div className="flex justify-between items-start mb-2">
                ...
                <span className="text-[#FF9E2C] font-bold">$149</span>
              </div>
            ...
            <div className="bg-stone-800 rounded-xl p-5 border border-stone-700">
              <div className="flex justify-between items-start mb-2">
                ...
                <span className="text-[#FF9E2C] font-bold">$49-$499</span>
              </div>
            ...
            <div className="bg-stone-800 rounded-xl p-5 border border-stone-700">
              <div className="flex justify-between items-start mb-2">
                ...
                <span className="text-[#FF9E2C] font-bold">$49-$99</span>
              </div>
      ...
      <section className="py-16 bg-gray-950 px-4 md:px-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-stone-800 to-stone-900 rounded-2xl p-8 border border-[#FF9E2C]/30">
            <div className="space-y-4 mb-8">
              <div className="flex justify-between items-center py-3 border-b border-stone-700">
                ...
                <span className="text-[#FF9E2C] font-bold">40% off Basic Price</span>
              </div>
              <div className="flex justify-between items-center py-3 border-b border-stone-700">
                <span className="text-white font-medium">Basic Bi-Weekly Package</span>
                <span className="text-[#FF9E2C] font-bold">50% off Basic Price</span>
              </div>
              <div className="flex justify-between items-center py-3 border-b border-stone-700">
                <span className="text-white font-medium">Premium VIP Monthly Package</span>
                <span className="text-[#FF9E2C] font-bold">40% off Complete Price</span>
              </div>
              <div className="flex justify-between items-center py-3 border-b border-stone-700">
                <span className="text-white font-medium">Premium VIP Bi-Weekly Package</span>
                <span className="text-[#FF9E2C] font-bold">50% off Complete Price</span>
              </div>
            </div>
      ...
      <section className="py-16 bg-stone-900 px-4 md:px-16">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-gray-900 to-stone-800 rounded-3xl p-10 md:p-12 text-center border border-[#FF9E2C]/20">
            <Gift className="w-12 h-12 text-[#FF9E2C] mx-auto mb-4" />
