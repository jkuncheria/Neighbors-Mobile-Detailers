...
const ChandlerAutoDetailing: React.FC = () => {
  ...
  const localFeatures = [
    {
      icon: <Briefcase className="w-8 h-8 text-[#FF9E2C]" />,
    ...
    {
      icon: <Users className="w-8 h-8 text-[#FF9E2C]" />,
      ...
      <section className="relative py-24 bg-gray-950 px-4 md:px-16">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <span className="text-[#FF9E2C] font-bold tracking-wider text-sm uppercase">CHANDLER SERVICE AREA</span>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mt-4 mb-6">
                Auto Detailing in Chandler, AZ
              </h1>
              <p className="text-lg text-gray-400 mb-4 leading-relaxed">
                Chandler combines thriving tech industry, beautiful master-planned communities, and family-friendly neighborhoods. Neighbors Mobile Detailers serves all of Chandler with convenient mobile detailing - whether you're at home in Ocotillo or working along the Price Corridor.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Why Chandler Chooses Neighbors Mobile Detailers
              </h2>
