      ...
      <section className="relative py-24 bg-gray-950 px-4 md:px-16">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <span className="text-[#FF9E2C] font-bold tracking-wider text-sm uppercase">SCOTTSDALE SERVICE AREA</span>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mt-4 mb-6">
                Professional Auto Detailing in Scottsdale, AZ
              </h1>
              <p className="text-lg text-gray-400 mb-8 leading-relaxed">
                Neighbors Mobile Detailers brings premium auto detailing services directly to you in Scottsdale. From luxury vehicles in North Scottsdale to everyday cars in Old Town, we deliver showroom-quality results at your home or office.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Why Scottsdale Chooses Neighbors Mobile Detailers
              </h2>
