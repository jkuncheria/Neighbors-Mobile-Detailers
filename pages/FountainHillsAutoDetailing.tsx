      ...
      <section className="relative py-24 bg-gray-950 px-4 md:px-16">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <span className="text-[#FF9E2C] font-bold tracking-wider text-sm uppercase">FOUNTAIN HILLS SERVICE AREA</span>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mt-4 mb-6">
                Auto Detailing in Fountain Hills, AZ
              </h1>
              <p className="text-lg text-gray-400 mb-4 leading-relaxed">
                Fountain Hills is a hidden gem in the Arizona desert - a peaceful community known for its world-famous fountain, stunning mountain views, and tight-knit residents. Neighbors Mobile Detailers is proud to bring premium mobile detailing services directly to this special community.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Why Fountain Hills Trusts Neighbors Mobile Detailers
              </h2>
