...
const PaintCorrection: React.FC = () => {
  const benefits = [
    ...
    {
      icon: <Layers className="w-8 h-8 text-[#FF9E2C]" />,
      ...
      <section className="py-24 bg-stone-950 px-4 md:px-16">
        ...
        <div className="mb-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <span className="text-[#FF9E2C] font-bold tracking-wider text-sm uppercase">PAINT CORRECTION</span>
            ...
            <div className="relative">
              <div className="overflow-hidden h-[500px] md:h-[600px] rounded-2xl shadow-2xl">
                <img 
                  ...
                  alt="Paint Correction Services in Austin" 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {packages.map((pkg, idx) => (
              <div key={idx} className="bg-stone-900 rounded-2xl p-6 border border-stone-800 hover:border-[#FF9E2C] hover:shadow-lg transition-all">
                ...
                <p className="text-[#FF9E2C] text-lg font-bold mb-4">{pkg.correction} defect removal</p>
