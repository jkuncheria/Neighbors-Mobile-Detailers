...
const Remodeling: React.FC = () => {
  ...
  return (
    <>
      <SEO
        title="Austin Home Remodeling | Neighbors Mobile Detailers"
        description="Professional home remodeling services in Austin, Arizona. Kitchens, bathrooms, additions, and full-space updates. Dust control, site protection, clear communication. Free estimates."
        keywords="Austin home remodeling, Austin house renovation, home remodel contractor Austin, whole house renovation Austin, home addition Austin"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mt-4 mb-6">
                Austin Home Remodeling | Transform Your Home with Professional Remodeling
              </h1>
            ...
            <div className="relative">
              <div className="overflow-hidden h-[500px] md:h-[600px] rounded-2xl">
                <img 
                  ...
                  alt="Home Remodeling Services in Austin, Arizona" 
