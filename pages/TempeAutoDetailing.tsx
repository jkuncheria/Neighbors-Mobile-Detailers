...
const TempeAutoDetailing: React.FC = () => {
  ...
  const localFeatures = [
    {
      icon: <GraduationCap className="w-8 h-8 text-[#FF9E2C]" />,
    ...
    {
      icon: <Building2 className="w-8 h-8 text-[#FF9E2C]" />,
      ...
      <section className="relative py-24 bg-gray-950 px-4 md:px-16">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <span className="text-[#FF9E2C] font-bold tracking-wider text-sm uppercase">TEMPE SERVICE AREA</span>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mt-4 mb-6">
                Auto Detailing in Tempe, AZ
              </h1>
              <p className="text-lg text-gray-400 mb-4 leading-relaxed">
                From ASU students keeping their first car pristine to tech professionals along the Tempe Town Lake corridor, Neighbors Mobile Detailers delivers premium mobile detailing services throughout Tempe.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Why Tempe Chooses Neighbors Mobile Detailers
              </h2>
