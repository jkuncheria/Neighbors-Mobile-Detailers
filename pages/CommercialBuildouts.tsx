...
const CommercialBuildouts: React.FC = () => {
  ...
  return (
    <>
      <SEO
        title="Austin Commercial Build-Outs & Tenant Improvements | Neighbors Mobile Detailers"
        description="Professional commercial build-outs and tenant improvements in Austin, Arizona. Fast, code-compliant build-outs with minimal downtime. Drywall, lighting, flooring, ADA upgrades. Free estimates."
        keywords="Austin commercial build-outs, Austin tenant improvements, commercial contractor Austin, office build-out Austin, retail build-out Austin, tenant improvement contractor Austin"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mt-4 mb-6">
                Austin Commercial Build-Outs | Fast, Code-Compliant Build-Outs with Minimal Downtime
              </h1>
            ...
            <div className="relative">
              <div className="overflow-hidden h-[500px] md:h-[600px] rounded-2xl">
                <img 
                  ...
                  alt="Commercial Build-Outs and Tenant Improvements in Austin, Arizona" 
