...
const LagoVistaAutoDetailing: React.FC = () => {
  const services = [
    {
  ...
  const benefits = [
    'Mobile service - we come to your Lago Vista location',
    'Serving Lago Vista, Jonestown, and Lake Travis area',
  ...
  return (
    <>
      <SEO
        title="Lago Vista Auto Detailing | Mobile Car Detailing & Ceramic Coating | Neighbors Mobile Detailers"
        description="Professional auto detailing services in Lago Vista, TX. Mobile detailing, ceramic coatings, paint correction, window tinting & PPF. Serving Lago Vista and Lake Travis area. Call (512) 679-7853 for a free quote!"
        keywords="Lago Vista auto detailing, mobile car detailing Lago Vista, ceramic coating Lago Vista TX, paint correction Lake Travis, window tinting Lago Vista, PPF Lago Vista, car wash Lago Vista TX"
        canonical="https://www.neighborsmobiledetailing.com/lago-vista-auto-detailing"
        serviceSchema={{
          name: "Lago Vista Auto Detailing Services",
          description: "Professional mobile auto detailing, ceramic coating, paint correction, and window tinting services in Lago Vista, Texas.",
          provider: "Neighbors Mobile Detailers",
          areaServed: ["Lago Vista", "Jonestown", "Point Venture", "Lake Travis", "Volente"],
          priceRange: "$$"
        }}
      />
      ...
      <section className="relative py-24 bg-gray-950 px-4 md:px-16">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <span className="text-[#FF9E2C] font-bold tracking-wider text-sm uppercase">LAGO VISTA SERVICE AREA</span>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mt-4 mb-6">
                Professional Auto Detailing in Lago Vista, TX
              </h1>
              <p className="text-lg text-gray-400 mb-8 leading-relaxed">
                Neighbors Mobile Detailers brings premium auto detailing services directly to you in Lago Vista. Serving the scenic Lake Travis area, we deliver showroom-quality results at your home or office.
              </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Our Lago Vista Auto Detailing Services
            </h2>
            <div className="w-20 h-1 bg-[#FF9E2C] mx-auto mb-6"></div>
            <p className="text-gray-400 max-w-2xl mx-auto">
              We offer a complete range of professional auto care services to Lago Vista residents and businesses.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Why Lago Vista Chooses Neighbors Mobile Detailers
              </h2>
      ...
      <section className="py-20 bg-stone-900 px-4 md:px-16">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <div className="w-20 h-1 bg-[#FF9E2C] mx-auto mb-6"></div>
            <p className="text-gray-400 max-w-2xl mx-auto">
              We provide mobile auto detailing services throughout Lago Vista and the Lake Travis area.
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-950 px-4 md:px-16">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-stone-900 to-stone-800 rounded-3xl p-10 md:p-16 text-center border border-stone-700">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Ready for Premium Auto Detailing in Lago Vista?
            </h2>
            <p className="text-gray-400 text-lg mb-8 max-w-2xl mx-auto">
              Contact us today for a free quote. We'll bring our professional detailing services directly to your Lago Vista location.
            </p>
...
export default LagoVistaAutoDetailing;
