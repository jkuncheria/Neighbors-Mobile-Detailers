...
const ScottsdaleLiving: React.FC = () => {
  ...
  return (
    <>
      <SEO
        title="Scottsdale Living Members | Exclusive 20% Off Auto Detailing | Neighbors Mobile Detailers"
        description="Exclusive offer for Scottsdale Living Facebook group members! Get 20% off all auto detailing services. Ceramic coatings, paint correction, window tinting & more. Call (512) 679-7853 and mention Scottsdale Living!"
        keywords="Scottsdale auto detailing discount, Scottsdale Living special offer, ceramic coating Scottsdale, auto detailing Scottsdale AZ, car detailing discount Austin"
        canonical="https://www.neighborsmobiledetailer.com/scottsdale-living"
      />
      ...
      <section className="relative py-16 bg-gradient-to-br from-gray-950 via-stone-900 to-gray-950 px-4 md:px-16 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          {/* Welcome Badge */}
          <div className="inline-flex items-center gap-2 bg-[#FF9E2C]/10 border border-[#FF9E2C]/30 rounded-full px-6 py-2 mb-8">
            <Users className="w-5 h-5 text-[#FF9E2C]" />
            <span className="text-[#FF9E2C] font-semibold text-sm uppercase tracking-wider">Exclusive Member Access</span>
          </div>

          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
            Welcome, <span className="text-[#FF9E2C]">Scottsdale Living</span> Members!
          </h1>
          ...
          <Link 
            to="/members-pricing" 
            className="inline-flex items-center gap-2 text-[#FF9E2C] hover:text-yellow-400 font-semibold mb-10 transition-colors"
          >
            View Our Complete Pricing Menu →
          </Link>

          {/* Main Offer Card */}
          <div className="bg-gradient-to-br from-stone-800 to-stone-900 rounded-3xl p-8 md:p-12 border border-[#FF9E2C]/30 shadow-2xl max-w-3xl mx-auto mb-10">
            <div className="flex items-center justify-center gap-3 mb-6">
              <Gift className="w-10 h-10 text-[#FF9E2C]" />
              <span className="text-[#FF9E2C] font-bold text-lg uppercase tracking-wider">Your Exclusive Offer</span>
            </div>
            
            <div className="flex items-center justify-center gap-4 mb-6">
              <Percent className="w-16 h-16 text-[#FF9E2C]" />
              <div className="text-left">
                <p className="text-6xl md:text-7xl font-black text-white">20<span className="text-[#FF9E2C]">%</span></p>
                <p className="text-2xl font-bold text-gray-300">OFF ALL SERVICES</p>
              </div>
            </div>
            
            <p className="text-xl text-white mb-4">
              Just mention <span className="text-[#FF9E2C] font-bold">"Scottsdale Living"</span> when booking!
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/contact"
                className="bg-[#FF9E2C] hover:bg-yellow-400 text-black font-bold py-4 px-10 rounded-xl shadow-lg transition transform hover:scale-105 text-center text-lg"
              >
                Claim Your Discount
              </Link>
              <a
          ...
          <div className="flex flex-wrap justify-center gap-8 text-gray-400">
            ...
            <div className="flex items-center gap-2">
              <Shield className="w-5 h-5 text-[#FF9E2C]" />
              <span>Fully Insured</span>
            </div>
            <div className="flex items-center gap-2">
              <Award className="w-5 h-5 text-[#FF9E2C]" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((service, idx) => (
              <Link
                key={idx}
                to={service.href}
                className="bg-stone-800 rounded-2xl p-6 border border-stone-700 hover:border-[#FF9E2C] transition-all group relative overflow-hidden"
              >
                <div className="absolute top-4 right-4 bg-[#FF9E2C] text-black text-xs font-bold px-2 py-1 rounded">
                  20% OFF
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Why Scottsdale Trusts Neighbors Mobile Detailers
              </h2>
      ...
      <section className="py-20 bg-stone-900 px-4 md:px-16">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-gray-900 to-stone-800 rounded-3xl p-10 md:p-16 text-center border border-[#FF9E2C]/20">
            <Gift className="w-16 h-16 text-[#FF9E2C] mx-auto mb-6" />
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Ready to Claim Your 20% Discount?
            </h2>
            <p className="text-gray-400 text-lg mb-8 max-w-2xl mx-auto">
              Contact us today and mention <span className="text-[#FF9E2C] font-bold">"Scottsdale Living"</span> to receive your exclusive member discount.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/contact"
