...
const AnthemAutoDetailing: React.FC = () => {
  const services = [
    ...
    },
    {
      ...
      description: 'Essential protection against the harsh North Austin desert sun and dust storms.',
    ...
    },
    {
      ...
      description: 'Shield your vehicle from rock chips on the long I-17 commute to Austin.',
  ...
  const benefits = [
    ...
    'No need to drive to Austin for quality detailing'
  ];
  ...
  const localFeatures = [
    {
      icon: <Home className="w-8 h-8 text-[#FF9E2C]" />,
      title: 'At-Home Convenience',
      description: 'Skip the 30+ minute drive to Austin. We bring professional detailing directly to your Anthem driveway while you enjoy your weekend.'
    },
    {
      icon: <Mountain className="w-8 h-8 text-[#FF9E2C]" />,
    ...
    <>
      <SEO
        ...
        serviceSchema={{
          ...
          areaServed: ["Anthem", "Anthem Country Club", "New River", "Desert Hills", "North Austin"],
          priceRange: "$$"
        }}
      />
      ...
      <section className="relative py-24 bg-gray-950 px-4 md:px-16">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <span className="text-[#FF9E2C] font-bold tracking-wider text-sm uppercase">ANTHEM SERVICE AREA</span>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mt-4 mb-6">
                Mobile Auto Detailing in Anthem, AZ
              </h1>
              <p className="text-lg text-gray-400 mb-4 leading-relaxed">
                Anthem residents no longer need to make the long drive to Austin for premium auto detailing. Neighbors Mobile Detailers brings professional-grade services directly to your home in Anthem Country Club, Parkside, or any Anthem neighborhood.
              </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              Comprehensive auto care services brought directly to your Anthem home - no Austin commute required.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((service, idx) => (
              <Link
                key={idx}
                to={service.href}
                className="bg-stone-900 rounded-2xl p-6 border border-stone-800 hover:border-[#FF9E2C] transition-all group"
              >
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-gray-900 to-stone-800 rounded-3xl p-10 md:p-16 text-center border border-stone-700">
            ...
            <p className="text-gray-400 text-lg mb-8 max-w-2xl mx-auto">
              Skip the drive to Austin. We'll bring professional auto detailing directly to your Anthem home.
            </p>
