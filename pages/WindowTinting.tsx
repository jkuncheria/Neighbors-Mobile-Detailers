...
const WindowTinting: React.FC = () => {
  const benefits = [
    ...
    {
      icon: <Thermometer className="w-8 h-8 text-[#FF9E2C]" />,
    ...
    {
      icon: <Lock className="w-8 h-8 text-[#FF9E2C]" />,
  ...
  return (
    <>
      <SEO
        title="Window Tinting Austin | Auto Tint | Ceramic Window Film"
        description="Professional window tinting in Austin. Ceramic, carbon, and dyed films. Heat rejection, UV protection, glare reduction. Legal tint levels. Free quotes."
        keywords="window tinting Austin, auto tint Austin, ceramic window tint, car window tinting, heat rejection film, UV protection tint"
      ...
      <section className="py-24 bg-stone-950 px-4 md:px-16">
        ...
        <div className="mb-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <span className="text-[#FF9E2C] font-bold tracking-wider text-sm uppercase">WINDOW TINTING</span>
            ...
            <div className="relative">
              <div className="overflow-hidden h-[500px] md:h-[600px] rounded-2xl shadow-2xl">
                <img 
                  ...
                  alt="Window Tinting Services in Austin" 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {tintLevels.map((level, idx) => (
              <div key={idx} className="bg-stone-900 rounded-2xl p-6 border border-stone-800 hover:border-[#FF9E2C] hover:shadow-lg transition-all">
                ...
                <p className="text-[#FF9E2C] text-xs font-semibold">Best for: {level.best}</p>
              </div>
            ))}
          </div>
        </div>
