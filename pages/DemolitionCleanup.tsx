...
const DemolitionCleanup: React.FC = () => {
  ...
  return (
    <>
      <SEO
        title="Austin Demolition & Cleanup Services | Neighbors Mobile Detailers"
        description="Professional demolition and cleanup services in Austin, Arizona. Safe demolition with site protection and debris hauling. We leave the space ready for construction. Free estimates."
        keywords="Austin demolition, Austin cleanup, demolition contractor Austin, construction cleanup Austin, debris removal Austin, site cleanup Austin"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mt-4 mb-6">
                Austin Demolition & Cleanup | Safe Demolition with Site Protection
              </h1>
            ...
            <div className="relative">
              <div className="overflow-hidden h-[500px] md:h-[600px] rounded-2xl">
                <img 
                  ...
                  alt="Demolition and Cleanup Services in Austin, Arizona" 
