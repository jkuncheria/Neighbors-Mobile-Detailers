...
export const NAV_ITEMS: NavItem[] = [
  ...
  { 
    ...
    href: '#',
    subItems: [
      { label: 'Austin', href: '/austin-auto-detailing' },
      { label: 'Round Rock', href: '/round-rock-auto-detailing' },
      { label: 'Cedar Park', href: '/cedar-park-auto-detailing' },
