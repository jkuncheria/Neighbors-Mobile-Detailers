    ...
    <section className="py-24 bg-gradient-to-b from-gray-50 to-white px-4 md:px-16 overflow-hidden">
      <div className="max-w-6xl mx-auto relative">
        ...
        <div className="text-center mb-20 relative z-10">
          <span className="font-bold tracking-wider text-sm uppercase" style={{ color: '#F21C1D' }}>ABOUT Neighbors Mobile Detailers</span>
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            From a classroom lesson to Austin's most trusted detailing service – here's how Neighbors Mobile Detailers came to be.
          </p>
        </div>
            ...
            <div>
              <div className="bg-white rounded-3xl shadow-xl p-8 md:p-10 border border-gray-100 hover:shadow-2xl transition-shadow duration-300">
                ...
                <div className="space-y-4 text-gray-600 leading-relaxed">
                  ...
                  <p>
                    In the spring of 2021, business was growing to more than we could handle. Mr. Chiarelli purchased a building in Austin and the legend grew.
                  </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center mb-16">
            <div className="order-2 lg:order-1">
              <div className="bg-white rounded-3xl shadow-xl p-8 md:p-10 border border-gray-100 hover:shadow-2xl transition-shadow duration-300">
                ...
                <div className="space-y-4 text-gray-600 leading-relaxed">
                  <p>
                    A state of the art <span className="font-bold text-gray-900">1,200 square-foot garage</span> in Austin where we could detail as many as four cars at the same time – completely shielded from any weather.
                  </p>
                  <p>
                  ...
                  <div className="flex flex-wrap gap-2 mt-4">
                    {['Austin', 'Castle Rock', 'Bennett', 'Highlands Ranch', 'Lakewood', 'Austin'].map((city) => (
