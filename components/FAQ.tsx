      ...
      questions: [
        {
          ...
          answer: 'We typically respond to all inquiries within 24 hours. For urgent matters or immediate assistance, please call us directly at (512) 679-7853. Our team is available to help with all your auto detailing needs.'
        },
        {
        ...
        },
        {
          ...
          answer: 'We proudly serve Austin, Anthem, Paradise Valley, Scottsdale, Chandler, Fountain Hills, and surrounding communities. Contact us to confirm if we service your specific area!'
        },
        {
          question: 'Where is your facility located?',
          answer: 'Our facility is located at 704 S Monaco St Pkwy, Austin, CO. We have a state-of-the-art shop equipped with the latest tools and technology to deliver exceptional results in a controlled environment.'
        }
      ]
    },
    {
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: 'Yes, we work by appointment to ensure we can dedicate the proper time and attention to your vehicle. Call us at (512) 679-7853 or use our contact form to schedule. We try to accommodate requests as quickly as possible.'
        },
        {
    ...
    <section className="py-24 bg-gray-950 px-4 md:px-16">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20">
          <span className="font-bold tracking-wider text-sm uppercase text-[#FF9E2C]">FAQ</span>
          ...
          <p className="text-lg text-gray-400 max-w-3xl mx-auto leading-relaxed">
            ...
            Can't find what you're looking for? <Link to="/contact" className="font-semibold hover:underline text-[#FF9E2C]">Contact us</Link> and we'll be happy to help.
          </p>
        </div>
          ...
          <div key={categoryIdx} className="mb-16">
            <div className="flex items-center mb-8">
              <div className="p-3 rounded-xl mr-4 bg-gray-800">
                <HelpCircle className="w-6 h-6 text-[#FF9E2C]" />
              </div>
            ...
            <div className="space-y-4">
              {category.questions.map((faq, idx) => {
                ...
                return (
                  <div 
                    key={idx}
                    className="bg-gray-900 border-2 border-gray-800 rounded-xl overflow-hidden transition-colors hover:border-[#FF9E2C]"
                  >
                    <button
                    ...
                    >
                      ...
                      {openFaq === globalIndex ? (
                        <ChevronUp className="w-5 h-5 flex-shrink-0 text-[#FF9E2C]" />
                      ) : (
        ...
        <div className="mt-20 bg-gradient-to-br from-gray-900 to-black rounded-2xl p-12 md:p-16 text-center border border-gray-800">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              to="/contact"
              className="text-black font-bold py-4 px-8 rounded-xl transition-all transform hover:scale-105 shadow-lg inline-flex items-center justify-center gap-2 bg-[#FF9E2C] hover:bg-yellow-400"
            >
              Contact Us
            </Link>
            <a 
              href="tel:5126797853"
              className="border-2 border-white text-white hover:bg-[#FF9E2C] hover:border-[#FF9E2C] font-bold py-4 px-8 rounded-xl transition-all inline-flex items-center justify-center gap-2"
            >
              Call (512) 679-7853
            </a>
          </div>
