...
const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    location: 'Austin, CO',
    rating: 5,
    text: 'Had my windows tinted and it made a huge difference in the Texass sun. Professional installation with no bubbles. My car stays so much cooler now!',
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Don't just take our word for it. See what real customers have to say about their auto detailing and protection experience in Austin.
          </p>
        </div>
