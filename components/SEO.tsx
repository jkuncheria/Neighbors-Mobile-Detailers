  ...
  useEffect(() => {
    ...
    if (serviceSchema) {
      ...
      const schema = {
        ...
        "provider": {
          "@type": "LocalBusiness",
          "name": serviceSchema.provider || "Neighbors Mobile Detailers",
          "telephone": "512-679-7853",
          "email": "neighborsmobiledetailing@outlook.com"
        },
        "areaServed": (serviceSchema.areaServed || ["Austin", "Scottsdale", "Paradise Valley", "Chandler", "Fountain Hills", "Anthem"]).map(area => ({
          "@type": "City",
          "name": area
        })),
